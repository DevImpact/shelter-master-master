package com.life.shelter.homeless.devimpact.Databeas;
...
import com.life.shelter.homeless.devimpact.Account;
...
public class UsersAccount extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == image && resultCode == RESULT_OK){
            ...
            StorageReference profileimageref = FirebaseStorage.getInstance().getReference("homelesspic/"
